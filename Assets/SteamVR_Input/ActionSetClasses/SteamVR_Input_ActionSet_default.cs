...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Vector2 Move_Player
        {
            get
            {
                return SteamVR_Actions.default_Move_Player;
            }
        }
        
        public virtual SteamVR_Action_Boolean ChangeColorButton
        {
            get
            {
                return SteamVR_Actions.default_ChangeColorButton;
            }
        }
